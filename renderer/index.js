...
function Ut() {
  ...
  return pr.Fragment = w, pr.jsxDEV = void 0, pr;
}
var yr = {}, hr = {}, Yt = {
  get exports() {
    return hr;
...
function Bt() {
  ...
  function Z(n, s, h) {
    this.props = n, this.context = s, this.refs = Fe, this.updater = h || Q;
  }
  ...
  var me = I.prototype = new ee();
  me.constructor = I, se(me, Z.prototype), me.isPureReactComponent = !0;
  var re = Array.isArray, N = Object.prototype.hasOwnProperty, B = { current: null }, ce = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ve(n, s, h) {
  ...
  function q(n, s, h, C, _) {
    ...
    else if (T = de(n), typeof T == "function")
  ...
  var l = { current: null }, fe = { transition: null }, Te = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: fe, ReactCurrentOwner: B };
  return b.Children = { map: M, forEach: function(n, s, h) {
    ...
    return n;
  } }, b.Component = Z, b.Fragment = ae, b.Profiler = Y, b.PureComponent = I, b.StrictMode = G, b.Suspense = ue, b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Te, b.cloneElement = function(n, s, h) {
    if (n == null)
    ...
    if (s != null) {
      ...
      for (T in s)
        N.call(s, T) && !ce.hasOwnProperty(T) && (C[T] = s[T] === void 0 && O !== void 0 ? O[T] : s[T]);
    }
    ...
    return n = { $$typeof: oe, _currentValue: n, _currentValue2: n, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, n.Provider = { $$typeof: J, _context: n }, n.Consumer = n;
...
function qt() {
  return st || (st = 1, function(w, d) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var ae = "18.2.0", G = Symbol.for("react.element"), Y = Symbol.for("react.portal"), J = Symbol.for("react.fragment"), oe = Symbol.for("react.strict_mode"), ye = Symbol.for("react.profiler"), ue = Symbol.for("react.provider"), ie = Symbol.for("react.context"), X = Symbol.for("react.forward_ref"), K = Symbol.for("react.suspense"), de = Symbol.for("react.suspense_list"), Q = Symbol.for("react.memo"), se = Symbol.for("react.lazy"), Fe = Symbol.for("react.offscreen"), Z = Symbol.iterator, ee = "@@iterator";
      function I(e) {
      ...
      M.ReactDebugCurrentFrame = ce, M.ReactCurrentActQueue = N;
      function te(e) {
        {
      ...
      function _e(e, r, a, o, i) {
        ...
        if (f) {
          ...
          if (Ie(R)) {
            var A = "";
            P != null && (A = pe(P) + "/"), _e(R, r, A, "", function(Mt) {
              return Mt;
            });
          } else
        ...
        var D, F, L = 0, U = o === "" ? er : o + wr;
        if (Ie(e))
          for (var vr = 0; vr < e.length; vr++)
            D = e[vr], F = U + Ae(D, vr), L += _e(D, r, a, F, i);
        else {
          var $r = I(e);
          if (typeof $r == "function") {
            ...
            for (var Lt = $r.call(nt), at, Vt = 0; !(at = Lt.next()).done; )
              D = at.value, F = U + Ae(D, Vt++), L += _e(D, r, a, F, i);
          } else if (y === "object") {
            var ot = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function E(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === J || e === ye || q || e === oe || e === K || e === de || z || e === Fe || Ce || Ye || we || typeof e == "object" && e !== null && (e.$$typeof === se || e.$$typeof === Q || e.$$typeof === ue || e.$$typeof === ie || e.$$typeof === X || // This needs to include all possible module reference object
...
` + m[P].replace(" at new ", " at ");
        ...
        var F = e ? e.displayName || e.name : "", L = F ? ir(F) : "";
...
Check the top-level render call using <` + a + ">.");
      ...
      function Jr(e, r) {
        if (!(!e._store || e._store.validated || e.key != null)) {
          ...
          if (!Kr[a]) {
            Kr[a] = !0;
            var o = "";
            e && e._owner && e._owner !== B.current && (o = " It was passed a child from " + le(e._owner.type) + "."), Me(e), l('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), Me(null);
          }
        }
      }
      function Xr(e, r) {
      ...
      function Zr(e, r, a) {
        ...
        if (!o) {
          ...
          y ? i += y : i += Gr();
          var f;
          e === null ? f = "null" : Ie(e) ? f = "array" : e !== void 0 && e.$$typeof === G ? (f = "<" + (le(e.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : f = typeof e, l("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", f, i);
        }
      ...
      function xt(e) {
        {
          ...
          try {
            if (N.isBatchingLegacy = !0, o = e(), !a && N.didScheduleLegacyUpdate) {
              var i = N.current;
              i !== null && (N.didScheduleLegacyUpdate = !1, Ir(i));
            }
          } catch (F) {
            throw dr(r), F;
          } finally {
          ...
          if (o !== null && typeof o == "object" && typeof o.then == "function") {
            ...
            if (dr(r), We === 0) {
              var P = N.current;
              P !== null && (Ir(P), N.current = null);
              var A = {
                then: function(F, L) {
                  N.current === null ? (N.current = [], xr(R, F, L)) : F(R);
                }
              };
              return A;
            } else {
      ...
      d.Children = Nt, d.Component = _, d.Fragment = J, d.Profiler = ye, d.PureComponent = V, d.StrictMode = oe, d.Suspense = K, d.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = M, d.cloneElement = It, d.createContext = ar, d.createElement = Ft, d.createFactory = $t, d.createRef = gr, d.forwardRef = c, d.isValidElement = be, d.lazy = u, d.memo = S, d.startTransition = At, d.unstable_act = xt, d.useCallback = ne, d.useContext = g, d.useDebugValue = pt, d.useDeferredValue = mt, d.useEffect = H, d.useId = ht, d.useImperativeHandle = vt, d.useInsertionEffect = Ee, d.useLayoutEffect = ur, d.useMemo = dt, d.useReducer = x, d.useRef = $, d.useState = W, d.useSyncExternalStore = gt, d.useTransition = yt, d.version = ae, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(zt, He)), He;
}
var ct;
...
function Gt() {
  return ft || (ft = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function me(t, u, c) {
      {
        var p = ee.ReactDebugCurrentFrame, E = p.getStackAddendum();
        E !== "" && (u += "%s", c = c.concat([E]));
    ...
    var re = !1, N = !1, B = !1, ce = !1, ve = !1, Re;
    Re = Symbol.for("react.module.reference");
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === G || t === J || ve || t === Y || t === ie || t === X || ce || t === Q || re || N || B || typeof t == "object" && t !== null && (t.$$typeof === de || t.$$typeof === K || t.$$typeof === oe || t.$$typeof === ye || t.$$typeof === ue || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    function z(t) {
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case de: {
            var E = t, S = E._payload, v = E._init;
            try {
              return z(v(S));
            } catch {
              return null;
    ...
    var q = Object.assign, M = 0, te, l, fe, Te, n, s, h;
    function C() {
    }
    ...
    function _() {
      {
        if (M === 0) {
          te = console.log, l = console.info, fe = console.warn, Te = console.error, n = console.group, s = console.groupCollapsed, h = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: C,
...
` + g[x].replace(" at new ", " at ");
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case K:
            return $e(t.type, u, c);
          case de: {
            var p = t, E = p._payload, S = p._init;
            try {
              return $e(S(E), u, c);
            } catch {
            }
          ...
          if (S(t, v)) {
            ...
            try {
              if (typeof t[v] != "function") {
                var W = Error((p || "React class") + ": " + c + " type `" + v + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof t[v] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw W.name = "Invariant Violation", W;
              }
              g = t[v](u, v, p, c, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (x) {
              g = x;
            }
            g && !(g instanceof Error) && (Pe(E), I("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", p || "React class", c, v, typeof g), Pe(null)), g instanceof Error && !(g.message in Oe) && (Oe[g.message] = !0, Pe(E), I("Failed %s type: %s", c, g.message), Pe(null));
          }
      }
    }
    ...
    function Be(t) {
      if (Xe(t))
        return I("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Je(t)), Le(t);
    }
    ...
    function be(t, u) {
      {
        var c = function() {
          Qe || (Qe = !0, I("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", u));
        };
    ...
    function er(t, u) {
      {
        var c = function() {
          Ze || (Ze = !0, I("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", u));
        };
    ...
    function Tr(t, u, c, p, E) {
      {
        var S, v = {}, g = null, W = null;
        c !== void 0 && (Be(c), g = "" + c), Rr(u) && (Be(u.key), g = "" + u.key), Er(u) && (W = u.ref, Cr(u, E));
        for (S in u)
          Se.call(u, S) && !_r.hasOwnProperty(S) && (v[S] = u[S]);
        if (t && t.defaultProps) {
        ...
        return wr(t, g, W, E, p, ge.current, v);
      }
    }
    ...
    function nr(t, u) {
      {
        ...
        tr[c] = !0;
        var p = "";
        t && t._owner && t._owner !== Ve.current && (p = " It was passed a child from " + z(t._owner.type) + "."), pe(t), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, p), pe(null);
      }
    }
    function ar(t, u) {
      {
        ...
        if (Ne(t))
          ...
          if (typeof E == "function" && E !== t.entries)
            for (var S = E.call(t), v; !(v = S.next()).done; )
              _e(v.value) && nr(v.value, u);
        }
      }
    }
    function xe(t) {
      {
        ...
        if (typeof u == "function")
          c = u.propTypes;
        else if (typeof u == "object" && (u.$$typeof === ue || // Note: Memo only checks outer props here.
        // Inner props are checked in the reconciler.
        u.$$typeof === K))
          c = u.propTypes;
        else
    ...
    function ze(t) {
      {
        for (var u = Object.keys(t.props), c = 0; c < u.length; c++) {
          var p = u[c];
          if (p !== "children" && p !== "key") {
            pe(t), I("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", p), pe(null);
            break;
          }
        }
        t.ref !== null && (pe(t), I("Invalid attribute `ref` supplied to `React.Fragment`."), pe(null));
      }
    }
    function or(t, u, c, p, E, S) {
      {
        var v = Ce(t);
        if (!v) {
          var g = "";
          ...
          W ? g += W : g += De();
          var x;
          t === null ? x = "null" : Ne(t) ? x = "array" : t !== void 0 && t.$$typeof === d ? (x = "<" + (z(t.type) || "Unknown") + " />", g = " Did you accidentally export a JSX literal instead of a component?") : x = typeof t, I("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", x, g);
        }
        var $ = Tr(t, u, c, E, S);
        if ($ == null)
          return $;
...
const lt = mr.Fragment, Ue = mr.jsxDEV, Kt = (w) => {
  ...
  return /* @__PURE__ */ Ue("input", { id: ae, className: "e-input", placeholder: "请输入你的数据", ...d }, void 0, !1, {
    fileName: "E:/vscode-project/easy-lowcode/src/components/Input.tsx",
    lineNumber: 12,
    columnNumber: 5
  }, globalThis);
}, Jt = (w) => {
  ...
  return /* @__PURE__ */ Ue("button", { id: ae, className: "e-button", ...d, children: d && d.children ? d.children : "默认按钮" }, void 0, !1, {
    fileName: "E:/vscode-project/easy-lowcode/src/components/Button.tsx",
    lineNumber: 12,
    columnNumber: 5
  }, globalThis);
}, Xt = {
  ...
  const { jsonObj: d } = w;
  return /* @__PURE__ */ Ue(lt, { children: ((G) => G.content.map((Y) => Object.entries(Xt).map(([J, oe]) => Y && Y.componentName && J === Y.componentName ? /* @__PURE__ */ Ue("div", { id: Y.id, children: /* @__PURE__ */ Ue(oe, { data: Y.data, id: Y.id }, Y.id, !1, {
    fileName: "E:/vscode-project/easy-lowcode/src/renderer/Renderer.tsx",
    lineNumber: 20,
    columnNumber: 13
  }, globalThis) }, void 0, !1, {
    fileName: "E:/vscode-project/easy-lowcode/src/renderer/Renderer.tsx",
